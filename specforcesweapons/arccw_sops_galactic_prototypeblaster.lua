...
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/sops/new/v_prototype_blaster.mdl"
SWEP.WorldModel = "models/arccw/kraken/sops/world/w_prototype_blaster.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SOPS_GALACTIC_PROTOTYPEBLASTER"
SWEP.DistantShootSound = "ArcCW_Kraken.SOPS_GALACTIC_PROTOTYPEBLASTER_Distant"
...
SWEP.IronSightStruct = {
    Pos = Vector(-4.179, -4.199, 1.495),
    Ang = Angle(0.203, -0.125, 0),
     Magnification = 1.5,
