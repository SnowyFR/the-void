...
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/sops/new/v_wookie_slug.mdl"
SWEP.WorldModel = "models/arccw/kraken/sops/world/w_wookie_slug.mdl"
...
SWEP.TracerNum = 1
SWEP.TracerCol = Color(250, 204, 0)
SWEP.TracerWidth = 1
...
SWEP.ShootSound = "ArcCW_Kraken.SOPS_GALACTIC_WOOKIESLUG"
SWEP.DistantShootSound = "ArcCW_Kraken.SOPS_GALACTIC_WOOKIESLUG_Distant"
