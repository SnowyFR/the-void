...
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/sops/new/c_dead_mans_tale.mdl"
SWEP.WorldModel = "models/arccw/kraken/sops/world/w_dead_mans_tale.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SOPS_GALACTIC_DEADMANSTALE"
SWEP.DistantShootSound = "ArcCW_Kraken.SOPS_GALACTIC_DEADMANSTALE_Distant"
