...
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/sops/new/v_fc1.mdl"
SWEP.WorldModel = "models/arccw/kraken/sops/world/w_fc1.mdl"
...
SWEP.TracerNum = 1
SWEP.TracerCol = Color(250, 183, 0)
SWEP.TracerWidth = 1
...
SWEP.ShootSound = "ArcCW_Kraken.SOPS_GALACTIC_FC1"
SWEP.DistantShootSound = "ArcCW_Kraken.SOPS_GALACTIC_FC1_Distant"
