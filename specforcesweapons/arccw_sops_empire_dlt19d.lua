...
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/sops/new/v_dlt19d.mdl"
SWEP.WorldModel = "models/arccw/kraken/sops/world/w_dlt19d.mdl"
...
SWEP.TracerWidth = 1
SWEP.Tracer = "railgun_tracer_red"
SWEP.HullSize = 1
...
SWEP.ShootSound = "ArcCW_Kraken.SOPS_EMPIRE_DLT19D"
SWEP.DistantShootSound = "ArcCW_Kraken.SOPS_EMPIRE_DLT19D_Distant"
...
SWEP.IronSightStruct = {
    Pos = Vector(-4.843, -10, 2),
    Ang = Angle(3.55, 0.094, 0),
     Magnification = 1.5,
...
SWEP.Attachments = {     
    ...
    },
    {
        ...
        Slot = {"foregrip", "bipod_e11x", "swrp_ubgl_grapple"},
        Bone = "dlt34",
        Offset = {
