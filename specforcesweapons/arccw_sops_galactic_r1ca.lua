...
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/sops/new/v_renegade_carbine.mdl"
SWEP.WorldModel = "models/arccw/kraken/sops/world/w_renegade_carbine.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SOPS_GALACTIC_R1CA"
SWEP.DistantShootSound = "ArcCW_Kraken.SOPS_GALACTIC_R1CA_Distant"
...
SWEP.IronSightStruct = {
    Pos = Vector(-4.652, -4.439, 2.2),
    Ang = Angle(1.3, 0.206, 0),
     Magnification = 1.5,
