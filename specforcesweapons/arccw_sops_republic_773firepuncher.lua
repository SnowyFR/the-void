...
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/sops/new/v_firepuncher_republic.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SOPS_REPUBLIC_773FIREPUNCHER_SHORT"
SWEP.DistantShootSound = "ArcCW_Kraken.SOPS_REPUBLIC_773FIREPUNCHER_SHORT_Distant"
