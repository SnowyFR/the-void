...
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/sops/new/v_imperial_repeater.mdl"
SWEP.WorldModel = "models/arccw/kraken/sops/world/w_imperial_repeater.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SOPS_EMPIRE_HEAVYREPEATER"
SWEP.DistantShootSound = "ArcCW_Kraken.SOPS_EMPIRE_HEAVYREPEATER_Distant"
