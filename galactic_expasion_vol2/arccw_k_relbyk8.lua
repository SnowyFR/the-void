...
SWEP.WorldModel = "models/arccw/kraken/galexpansion_vol2/worldmodel/w_elg.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SW_RELBY_Close"
SWEP.DistantShootSound = "ArcCW_Kraken.SW_RELBY_Distant"
