...
SWEP.ViewModel = "models/arccw/kraken/republic/v_repshield.mdl"
SWEP.WorldModel = "models/arccw/kraken/republic/v_repshield.mdl"
...
SWEP.ShieldProps = {
    {
        Model = "models/arccw/kraken/republic/v_repshield.mdl",
        Pos = Vector(0, -15, -12),
        Ang = Angle(0, 0, 180 - 15),
        Resistance = 100
    }
