...
SWEP.PrintName = "DC-17m Modular"
SWEP.Trivia_Class = "Modular Weapon System"
SWEP.SubCategory = "3Rifles"
SWEP.Trivia_Desc = "The DC-17m Interchangeable Weapon System used by Republic clone commandos during the Clone Wars. Its modular barrel can be swapped between a repeating blaster rifle, anti-personnel shotgun, and long-range sniper configuration."
...
SWEP.AttachmentElements = {
    ["dc17m_shotgun"] = {
        VMBodygroups = {{ind = 1, bg = 1}, {ind = 4, bg = 1}},
        WMBodygroups = {{ind = 1, bg = 1}, {ind = 4, bg = 1}},
        VMElements = {
            {
    ...
    ["dc17m_sniper"] = {
        VMBodygroups = {{ind = 1, bg = 2}, {ind = 3, bg = 1}},
        WMBodygroups = {{ind = 1, bg = 2}, {ind = 3, bg = 1}},
        VMElements = {
            {
                Model = "models/hunter/plates/plate.mdl",
                Bone = "DC-17M",
    ...
    ["dc17m_launcher"] = {
        VMBodygroups = {{ind = 1, bg = 3}, {ind = 3, bg = 2}},
