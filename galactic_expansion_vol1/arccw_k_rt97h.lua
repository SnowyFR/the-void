...
SWEP.WorldModel = "models/arccw/kraken/galactic/worldmodels/w_rt97c.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SW_GALACTIC_RT97_Close"
SWEP.DistantShootSound = "ArcCW_Kraken.SW_GALACTIC_RT97_Distant"
