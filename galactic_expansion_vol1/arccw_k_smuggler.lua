...
SWEP.WorldModel = "models/arccw/kraken/galactic/worldmodels/w_smuggler.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SW_GALACTIC_S5_Close"
SWEP.DistantShootSound = "ArcCW_Kraken.SW_GALACTIC_S5_Distant"
