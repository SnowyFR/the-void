...
SWEP.WorldModel = "models/arccw/kraken/galactic/worldmodels/w_carablaster.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SW_GALACTIC_BRYAR_Close"
SWEP.DistantShootSound = "ArcCW_Kraken.SW_GALACTIC_BRYAR_Distant"
