...
SWEP.WorldModel = "models/arccw/kraken/galactic/worldmodels/w_bowcaster.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SW_GALACTIC_BOWCASTER_Close"
SWEP.DistantShootSound = "ArcCW_Kraken.SW_GALACTIC_BOWCASTER_Distant"
