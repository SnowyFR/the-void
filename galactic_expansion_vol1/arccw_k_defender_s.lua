...
SWEP.WorldModel = "models/arccw/kraken/galactic/worldmodels/w_defender.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SW_GALACTIC_DEFENDER_Close"
SWEP.DistantShootSound = "ArcCW_Kraken.SW_GALACTIC_DEFENDER_Distant"
