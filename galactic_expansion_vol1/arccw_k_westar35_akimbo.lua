...
SWEP.WorldModel = "models/arccw/kraken/galactic/worldmodels/w_westar35.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SW_GALACTIC_X8_Close"
SWEP.DistantShootSound = "ArcCW_Kraken.SW_GALACTIC_X8_Distant"
...
if CLIENT then
    SWEP.HandWM = {
        RH = { -- Right Hand
            model = "models/arccw/kraken/galactic/worldmodels/w_westar35.mdl",
