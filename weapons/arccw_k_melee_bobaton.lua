...
SWEP.IconOverride = "entities/kraken/empire-essentials/bobaton.png"
...
SWEP.ViewModel = "models/arccw/kraken/empire/v_melee_borifle.mdl"
SWEP.WorldModel = "models/arccw/kraken/empire/v_melee_borifle.mdl"
