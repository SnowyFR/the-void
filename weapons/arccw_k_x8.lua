...
SWEP.IconOverride = "entities/kraken/empire-essentials/x8.png"

-- Viewmodel & Entity Properties
SWEP.MirrorVMWM = true
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/empire/v_x8.mdl"
SWEP.WorldModel = "models/arccw/kraken/w_scoutblaster.mdl"
...
SWEP.ShootSound = "ArcCW_Kraken.SW_X8_Close"
SWEP.DistantShootSound = "ArcCW_Kraken.SW_X8_Distant"
...
SWEP.Attachments = {     
    ...
    {
        PrintName = "Muzzle",
        DefaultAttName = "X-8 Muzzle",
        Slot = {"muzzle", "cr2_muzzle", "cr2c_muzzle", "stealth_muzzle"},
        Bone = "DC-15SA",
        InstalledEles = {"muzzle_default"},
        Offset = {
            vpos = Vector(0.050, -1.2, 1.9),
            vang = Angle(90, 0, -90),
        },
    },  
    {
