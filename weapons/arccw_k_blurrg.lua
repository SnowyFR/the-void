...
SWEP.IconOverride = "entities/kraken/empire-essentials/blurg.png"

-- Viewmodel & Entity Properties
SWEP.MirrorVMWM = true
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/empire/v_blurrg.mdl"
SWEP.WorldModel = "models/arccw/kraken/empire/worldmodel/w_blurrg.mdl"
