...
SWEP.IconOverride = "entities/kraken/empire-essentials/a280cfe_rifle.png"

-- Viewmodel & Entity Properties
SWEP.DefaultBodygroups = "00110000"
SWEP.MirrorVMWM = true
SWEP.UseHands = true
SWEP.NoHideLeftHandInCustomization = false
SWEP.ViewModel = "models/arccw/kraken/empire/v_a280cfe.mdl"
SWEP.WorldModel = "models/arccw/kraken/empire/worldmodel/w_a280cfe_rifle.mdl"
