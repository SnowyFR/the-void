...
SWEP.Trivia_Country = "Mercenaries, Rebel Alliance"
SWEP.IconOverride = "entities/kraken/empire-essentials/dl44.png"

-- Viewmodel & Entity Properties
SWEP.MirrorVMWM = true
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/empire/v_dl44.mdl"
SWEP.WorldModel = "models/arccw/kraken/empire/worldmodel/w_dl44.mdl"
