...
SWEP.IconOverride = "entities/kraken/empire-essentials/edgesh.png"
...
SWEP.MirrorWorldModel = "models/arccw/kraken/empire/v_edgesh_mirror.mdl"
SWEP.ViewModel = "models/arccw/kraken/empire/v_edgesh.mdl"
SWEP.WorldModel = "models/arccw/kraken/empire/worldmodel/w_edgesh.mdl"
...
local path = "arccw/kraken/empire/edgesh/interaction/"
...
SWEP.Animations = {
    ...
    ["sgreload_insert"] = {
        ...
        TPAnim = ACT_HL2MP_GESTURE_RELOAD_SHOTGUN,
        SoundTable = {
            {s = path .. "xm1014_insertshell_01.ogg", t = 5/30},
        },
    },
    ["sgreload_finish"] = {
        Source = "reload_end",
    ...
    ["holster"] = {
        Source = "holster",
        SoundTable = {
            {s = "arccw/kraken/interaction/movement1.wav", t = 0/30},
        },
    },
    ["idle"] = {
        Source = "idle",
    ...
    ["exit_inspect"] = {
        ...
        SoundTable = {
            ...
            {s = "arccw/kraken/interaction/movement2.wav", t = 70/30},
            {s = "arccw/kraken/interaction/movement3.wav", t = 110/30},
        },
    },
    ["bash"] = {
